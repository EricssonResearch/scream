...
int main(int argc, char* argv[])
{
    ...
    if (mode & 0x01)
        ...
        screamTx->registerNewStream(rtpQueue[0], 10, 1.0f, 500e3f, 1000e3f, 5e6f, 1e6f, 0.2f, 0.1f, 0.1f);
    ...
    if (mode & 0x02)
        ...
        screamTx->registerNewStream(rtpQueue[1], 11, 0.5f, 500e3f, 1000e3f, 5e6f, 1e6f, 0.2f, 0.1f, 0.1f);
