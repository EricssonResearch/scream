...
int main(int argc, char* argv[])
{
    ...
    while (time <= Tmax) {
        ...
        time_ntp_tx = time_ntp + 1 * 0xFFFF0000;
        ...
        */
        ...
        if (retVal == 0) {
            ...
            */
            ...
            retVal = screamTx->addTransmitted(time_ntp_tx, ssrc, size, seqNr);
            nextCallN = n + max(1, (int)(1000.0*retVal));
            isEvent = true;
        }
