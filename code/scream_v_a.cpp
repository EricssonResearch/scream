...
int main(int argc, char* argv[])
{
    ...
    NetQueue *netQueueDelay = new NetQueue(0.03f, 0.0f, 0.0f);
    ...
    if (mode & 0x01)
		screamTx->registerNewStream(rtpQueue[0], 10, 1.0f, 1.5e6f, 3e6f, 20e6f, 10e6f, 1.0f, 0.1f, 0.2f, 0.1f, 0.9f, 0.95f, false, 0.1f);
    if (mode & 0x02)
